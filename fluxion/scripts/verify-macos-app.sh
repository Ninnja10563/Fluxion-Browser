...
"$fluxion_root/scripts/verify-macos-sleep.sh" "$app"
FLUXION_PROFILE="$profile" FLUXION_VISUAL_WORKSPACE_RESUME_TEST=1 FLUXION_VISUAL_GROUP_TEST=1 FLUXION_VISUAL_SPLIT_TEST=1 FLUXION_VISUAL_STATUS_TEST=1 FLUXION_VISUAL_DROP_TEST=1 FLUXION_VISUAL_FOCUS_TEST=1 FLUXION_VISUAL_TOOLBAR_MENU_TEST=1 FLUXION_VISUAL_PAGE_MENU_TEST=1 FLUXION_VISUAL_PALETTE_COMMAND_TEST=1 FLUXION_VISUAL_CLOSED_TABS_TEST=1 FLUXION_VISUAL_SEARCH_ENGINE_TEST=1 FLUXION_VISUAL_THEME_TEST=1 FLUXION_VISUAL_CLEAR_DATA_TEST=1 FLUXION_VISUAL_ORGANISATION_TEST=1 FLUXION_VISUAL_SCALE_TEST=1 FLUXION_VISUAL_MEMORY_TEST=1 FLUXION_VISUAL_ENRICHMENT_TEST=1 FLUXION_VISUAL_GROUNDING_TEST=1 FLUXION_VISUAL_EMBEDDING_SETTINGS_TEST=1 FLUXION_VISUAL_SETTINGS_TEST=1 FLUXION_VISUAL_WORKSPACE_SETTINGS_TEST=1 FLUXION_VISUAL_SLEEP_TEST=0 FLUXION_VISUAL_PEEK_TEST=1 FLUXION_VISUAL_MULTISELECT_TEST=1 FLUXION_VISUAL_SHORTCUT_TEST=1 FLUXION_VISUAL_AI_TEST=1 FLUXION_VISUAL_AI_COMPARE_TEST=1 FLUXION_VISUAL_LIBRARY_TEST=1 FLUXION_VISUAL_BOOKMARK_FOLDER_TEST=1 FLUXION_VISUAL_PERMISSIONS_TEST=1 FLUXION_VISUAL_ABOUT_TEST=1 \
...
while (( attempt < 360 )); do
  if [[ -f "$profile/prefs.js" ]] && \
      ...
      grep -q 'user_pref("fluxion.toolbarMenu.icon.health", "dark-inline-svg-and-contrast-verified")' "$profile/prefs.js" && \
...
if [[ -f "$profile/prefs.js" ]]; then
  ...
  grep 'user_pref("fluxion\.closeStability\.visual\.error"' "$profile/prefs.js" >&2 || true
  grep 'user_pref("fluxion\.groups\.collapsed\.visual\.error"' "$profile/prefs.js" >&2 || true
